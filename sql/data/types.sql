...
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(1,'Internet Explorer','%MSIE%',2);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(2,'Netscape','Mozilla%(%;%[UIN][);]%',2);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(3,'Internet Explorer 3','%MSIE 3%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(4,'Internet Explorer 4','%MSIE 4%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(5,'Internet Explorer 5','%MSIE 5%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(6,'Internet Explorer 6','%MSIE 6%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(7,'Netscape 3','Mozilla/3%(%;%[UIN][ );]%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(8,'Netscape 4','Mozilla/4%(%;%[UIN][ );]%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(9,'Netscape 6','Mozilla/5%(%;%[UIN][ );]%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(10,'Netscape 7','Mozilla%/5;%netscape/7%',4);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(11,'Windows','%win%',1);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(12,'Macintosh','%mac%',1);

INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(13,'Windows Internet Explorer','%MSIE%win%',3);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(14,'Windows Internet Explorer 3','%MSIE 3%win%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(15,'Windows Internet Explorer 4','%MSIE 4%win%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(16,'Windows Internet Explorer 5.0','%MSIE 5.0%win%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(17,'Windows Internet Explorer 5.5','%MSIE 5.5%win%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(18,'Windows Internet Explorer 6','%MSIE 6%win%',5);

INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(19,'Windows Netscape','Mozilla%(%win%;%[UIN][ );]%',3);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(20,'Windows Netscape 3','Mozilla/3%(%win%;%[UIN][ );]%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(21,'Windows Netscape 4','Mozilla/4%(%win%;%[UIN][ );]%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(22,'Windows Netscape 6','Mozilla/5%(%win%;%[UIN][ );]%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(23,'Windows Netscape 7','Mozilla/5%(%win%netscape/7%',5);

INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(24,'Macintosh Internet Explorer','%MSIE%mac%',3);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(25,'Macintosh Internet Explorer 3','%MSIE 3%mac%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(26,'Macintosh Internet Explorer 4','%MSIE 4%mac%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(27,'Macintosh Internet Explorer 5','%MSIE 5%mac%',5);

INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(28,'Macintosh Netscape','Mozilla%(%mac%;%[UIN][ );]%',3);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(29,'Macintosh Netscape 3','Mozilla/3%(%mac%;%[UIN][ );]%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(30,'Macintosh Netscape 4','Mozilla/4%(%mac%;%[UIN][ );]%',5);
INSERT INTO browsers (browser_id, iname, user_agent, ivalue) VALUES(31,'Macintosh Netscape 6','Mozilla/5%(%mac%;%[UIN][ );]%',5);

INSERT INTO sys_types (type_id,iname) VALUES(0,'StartDocument');
INSERT INTO sys_types (type_id,iname) VALUES(1,'SessionCounter');
INSERT INTO sys_types (type_id,iname) VALUES(2,'SessionCounterDate');
INSERT INTO sys_types (type_id,iname) VALUES(3,'SystemMessage');
INSERT INTO sys_types (type_id,iname) VALUES(4,'ServerMaster');
INSERT INTO sys_types (type_id,iname) VALUES(5,'ServerMasterAddress');
INSERT INTO sys_types (type_id,iname) VALUES(6,'WebMaster');
INSERT INTO sys_types (type_id,iname) VALUES(7,'WebMasterAddress');
