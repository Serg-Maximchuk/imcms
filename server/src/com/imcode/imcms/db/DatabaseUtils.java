...
public class DatabaseUtils {
    ...
    public static String executeStringQuery( Database database, final String sql, final Object[] parameters ) throws DatabaseException {
        return (String)database.execute( new SqlQueryDatabaseCommand( sql, parameters, new ObjectFromFirstRowResultSetHandler(new StringFromRowFactory()) ) );
    }
    ...
    public static String[] executeStringArrayQuery( Database database, final String sql, final Object[] parameters ) throws DatabaseException {
        return (String[])database.execute( new SqlQueryDatabaseCommand( sql, parameters, new StringArrayResultSetHandler() ) );
    }
    ...
    public static String[][] execute2dStringArrayQuery( Database database, final String sql, final Object[] parameters ) throws DatabaseException {
        return (String[][])database.execute( new SqlQueryDatabaseCommand( sql, parameters, new StringArrayArrayResultSetHandler() ) );
    }

    public static int executeUpdate( Database database, final String sql, final Object[] parameters ) throws DatabaseException {
        return ((Integer)database.execute( new SqlUpdateDatabaseCommand( sql, parameters ) )).intValue();
    }
    ...
    public static Object executeObjectQuery(Database database, String sql, String[] parameters,
        ...
        return database.execute(new SqlQueryDatabaseCommand(sql, parameters, new ObjectFromFirstRowResultSetHandler(objectFromRowFactory)));
    }

    public static Object[] executeObjectArrayQuery(Database database, String sql, String[] parameters,
                                                   RowTransformer objectFromRowFactory) {
        return (Object[])database.execute(new SqlQueryDatabaseCommand(sql, parameters, new ObjectArrayResultSetHandler(objectFromRowFactory)));
    }
