...
String subHeading = inDeleteCategoryMode ? bundle.getString("install/htdocs/sv/jsp/category_admin/remove_category") : bundle.getString("install/htdocs/sv/jsp/category_admin/edit_category");
%><%
				if (showLine) { %>
        <tr>
					<td colspan="2">&nbsp;<br><br>
        ...
        <tr>
		    <td width="110" height="24" class="imcmsAdmText" nowrap><fmt:message key="install/htdocs/sv/jsp/category_admin/category_name"/> &nbsp;</td>
            <td>
						...
						<tr>
							...
							if (readonly) { %>
							<td>&nbsp;&nbsp;</td>
							<td><fmt:message key="install/htdocs/sv/jsp/category_admin/category_id"/>: <%= categoryToEdit.getId() %></td><%
							} %>
						</tr>
						</table></td>
        </tr>
        <tr>
		    <td class="imcmsAdmText" nowrap><fmt:message key="install/htdocs/sv/jsp/category_admin/description"/> &nbsp;</td>
            <td>
...
<%= StringEscapeUtils.escapeHtml((String)ObjectUtils.defaultIfNull(categoryToEdit.getDescription(),"")) %></textarea>
        ...
        <tr>
						<td class="imcmsAdmText" valign="top" style="padding-top:3px;" nowrap><fmt:message key="install/htdocs/sv/jsp/category_admin/icon"/> &nbsp;</td>
            <td>
        ...
        <% if (!readonly) { %>
        <tr>
		    <td class="imcmsAdmText" nowrap><fmt:message key="install/htdocs/sv/jsp/category_admin/add_to_category_type"/> &nbsp;</td>
