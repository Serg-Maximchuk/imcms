...
<%
    CategoryTypeDomainObject categoryTypeToEdit = (CategoryTypeDomainObject)request.getAttribute( "categoryType" ) ;
            %><tr>
                <td width="110" height="24"><fmt:message key="global/Name"/></td>
            ...
            <tr>
                ...
                <td>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td><label for="<%=AdminCategories.PARAMETER__MAX_CHOICES%>1"><fmt:message key="install/htdocs/sv/jsp/category_admin/singel_choice"/></label></td>
							</tr>
							</table></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                 <td>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td><label for="<%=AdminCategories.PARAMETER__MAX_CHOICES%>0"><fmt:message key="install/htdocs/sv/jsp/category_admin/multi_choice"/></label></td>
							</tr>
							</table></td>
            </tr>
            <tr>
                <td><label for="<%=AdminCategories.PARAMETER__INHERITED%>"><fmt:message key="install/htdocs/sv/jsp/category_admin/inherited"/></label></td>
            ...
            <tr>
                <td><label for="<%=AdminCategories.PARAMETER__IMAGE_ARCHIVE%>"><fmt:message key="install/htdocs/sv/jsp/category_admin/image_archive"/></label></td>
