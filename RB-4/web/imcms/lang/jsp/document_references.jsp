...
%><vel:velocity><html>
    <head>
        <title><fmt:message key="web/imcms/lang/jsp/document_references.jsp/heading"/></title>
        <link rel="stylesheet" type="text/css" href="$contextPath/imcms/css/imcms_admin.css.jsp">
    </head>
    <body>
        #gui_outer_start()
        #gui_head( '<fmt:message key="web/imcms/lang/jsp/document_references.jsp/heading"/>' )
				...
				<tr>
					<td><input type="submit" class="imcmsFormBtn" name="<%= DocumentReferences.REQUEST_PARAMETER__BUTTON_RETURN %>" value="<fmt:message key="global/back"/>"></td>
				</tr>
				</form>
				</table>
        #gui_mid()
        <table border="0" cellspacing="0" cellpadding="2" width="400">
            <tr>
                <td colspan="2">#gui_heading( '<fmt:message key="web/imcms/lang/jsp/document_references.jsp/explanation"/>' )</td>
            </tr>
            <tr>
                <td width="15%" align="center"><b><fmt:message key="web/imcms/lang/jsp/heading_status"/>&nbsp;</b></td>
                <td width="85%"><b><fmt:message key="web/imcms/lang/jsp/heading_adminlink"/></b></td>
            </tr>
        <%
            ...
            <tr>
                ...
                <td>
                    <a href="<%= request.getContextPath() %>/servlet/AdminDoc?meta_id=<%= textDocument.getId() %>&<%= AdminDoc.PARAMETER__DISPATCH_FLAGS %>=<%= ImcmsConstants.DISPATCH_FLAG__EDIT_MENU %>&editmenu=<%= menuIndex %>">
                        ...
                        -
                        <fmt:message key="web/imcms/lang/jsp/document_references.jsp/heading_menu"/> <%= menuIndex %>
                    </a>
                </td>
            </tr>
        <% } %>
