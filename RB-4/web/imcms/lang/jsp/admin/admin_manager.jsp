...
<%
    Tab[] tabs = {
        new Tab(AdminManager.PARAMETER_VALUE__SHOW_CREATE, bundle.getString("web/imcms/lang/jsp/admin/admin_manager.jsp/tab_name/0"), "AdminManager?show=" + AdminManager.PARAMETER_VALUE__SHOW_CREATE ),
        new Tab(AdminManager.PARAMETER_VALUE__SHOW_RECENT, bundle.getString("web/imcms/lang/jsp/admin/admin_manager.jsp/tab_name/1"), "AdminManager?show=" + AdminManager.PARAMETER_VALUE__SHOW_RECENT ),
        new Tab(AdminManager.PARAMETER_VALUE__SHOW_REMINDERS, bundle.getString("web/imcms/lang/jsp/admin/admin_manager.jsp/tab_name/2"), "AdminManager?show=" + AdminManager.PARAMETER_VALUE__SHOW_REMINDERS),
        new Tab(AdminManager.PARAMETER_VALUE__SHOW_SUMMARY, bundle.getString("web/imcms/lang/jsp/admin/admin_manager.jsp/tab_name/3"), "AdminManager?show=" + AdminManager.PARAMETER_VALUE__SHOW_SUMMARY),
        new Tab(AdminManager.PARAMETER_VALUE__SHOW_SEARCH, bundle.getString("global/Search"), "AdminManager?show=" + AdminManager.PARAMETER_VALUE__SHOW_SEARCH)
    } ;
...
<title><fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/6"/></title>
...
#gui_outer_start()
<!--gui_head -->
#gui_head( "<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/1"/> - <%= adminManagerPage.getHeading().toLocalizedString( request ) %>" )
<!-- /gui_head -->
        ...
        <tr>
			...
			<tr>
				...
				%>name="submit"<%
				%> value="<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/2"/>"></td>
			</tr><%
			} else { %>
			<tr>
				<td>&nbsp;</td>
			...
			<form action="StartDoc">
			    <td colspan="2" align="right"><input type="submit" class="imcmsFormBtnSmall" value="<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/3"/>">&nbsp;&nbsp;
                    <input type="button" value="<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/4"/>" title="<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/5"/>" 
...
if (!AdminManager.PARAMETER_VALUE__SHOW_SEARCH.equals(adminManagerPage.getTabName())) {
	...
	<tr>
		<td colspan="2" height="22"><span class="imcmsAdmHeading"><fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/heading_create_new"/></span></td>
	</tr>
	<tr>
	...
	<tr>
		<td>
		<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/create_new"/>
		<select name="<%= AdminManager.REQUEST_PARAMETER__CREATE_DOCUMENT_ACTION %>"><%
			...
			<option value="<%= AdminManager.REQUEST_PARAMETER__ACTION__COPY %>"><fmt:message key="global/Copy"/></option>
		</select>
		&nbsp;<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/based_on"/>&nbsp;
		...
		&nbsp;<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/with_document"/>&nbsp;
		<input type="text" id="document_id" name="<%= AdminManager.REQUEST_PARAMETER__NEW_DOCUMENT_PARENT_ID %>" value="" size="40" maxlength="255">&nbsp;
		<input type="submit" name="<%= AdminManager.REQUEST_PARAMETER__CREATE_NEW_DOCUMENT %>" value="<fmt:message key="web/imcms/lang/jsp/admin/admin_manager.jsp/create_button"/>" class="imcmsFormBtnSmall"></td>
	</tr>
    <tr>
	...
	<tr>
		<td colspan="2" height="22"><span class="imcmsAdmHeading"><fmt:message key="web/imcms/lang/jsp/admin/admin_manager_search.jsp/1"/></span></td>
	</tr>
	<tr>
		<td colspan="2"><img src="<%= imagesPath %>/1x1_20568d.gif" width="100%" height="1" vspace="8"></td>
	</tr>
