...
<script language="JavaScript" src="@rooturl@/inc/include_validate_user.js"></script>
...
<tr>
	<td><img src="@imageurl@/clear.gif" width="1" height="25" alt="" border="0"></td>
</tr>
<tr>
	<td>
	<table border="0" cellspacing="0" cellpadding="0" width="349">
	<tr>
		<td width="50"><img src="@imageurl@/clear.gif" width="50" height="1" alt="" border="0"></td>
		...
		*Obligatoriska uppgifter<br><br>
		...
		<form name="regForm" method="POST" action="@servleturl@/AdminUserProps?SAVE_USER=true" onSubmit="checkValues('regForm'); return false">
		<input type="hidden" name="adminTask" value="ADD_USER">
		<input type="hidden" name="userTemplate" value="true">
		<input type="hidden" name="next_url" value="@rooturl@/shop/cart.jsp">
		<input type="hidden" name="active" value="1">
		<input type="hidden" name="user_type" value="1">
		<input type="hidden" name="roles" value="2">
		<tr>
			<td width="163"><img src="@imageurl@/clear.gif" width="163" height="1" alt="" border="0"></td>
		...
		<tr>
			<td colspan="2"><img src="@imageurl@/clear.gif" width="1" height="10" border="0"></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="right"><input type="image" name="SAVE_USER" value="Spara" src="@imageurl@/knapp_skapa_anv.gif" border="0"></td>
		</tr>
		</form>
