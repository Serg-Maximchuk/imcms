...
<tr>
	<td background="@imageurl@/varukorg_bg.gif">
	<table border="0" cellpadding="0" cellspacing="0" width="521">
	<tr valign="bottom">
		<td height="67" background="#">
		<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td background="#"><img src="@imageurl@/1x1.gif" width="76" height="1"></td>
		...
		<tr>
			<td colspan="2" background="#"><img src="@imageurl@/1x1.gif" width="1" height="31"></td>
		</tr>
		</table></td>
		<td align="right" background="#">
		<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td background="#"><a href="javascript: openPopup('@rooturl@/shop/cart.jsp',1);"><img src="@imageurl@/varukorg_knapp_skicka.gif" width="156" height="25" alt="" border="0"></a></td>
			<td background="#"><img src="@imageurl@/1x1.gif" width="14" height="1"></td>
		</tr>
		<tr>
			<td colspan="2" background="#"><img src="@imageurl@/1x1.gif" width="1" height="24"></td>
		</tr>
		</table>
	</td>
	</tr>
